          ...
          <section className="max-w-6xl mx-auto py-40 px-4 space-y-20 overflow-x-hidden">
            ...
            <div className="flex flex-col space-y-4">
              <div>
                ...
                Bachelor of Engineering (B.Eng.) Student <span className="text-xl font-light">(2024 - 2028)</span>
                </h3>
              ...
              where I get to explore real-world problem solving through lab experiements
               and design assignments. I've always been curious about how things work at a low level - 
               whether that's code running close to the metal or the flow of electricity through a power grid. 
               Lately, I've been especially drawn to power systems and the growing role of automation and electrification in our world. 
               I'm still exploring exactly where I want to specialize, but I know I love building things that are both practical and impactful.
              </p>
            </div>
