...
import signUp from "@/public/SignUpPage.png";
        ...
        <section className="  flex flex-col max-w-6xl mx-auto py-40 px-10 overflow-hidden">
          ...
          <div className="pb-44 flex flex-col space-y-4">
            ...
            <p className="text-xl" data-aos="fade-in" data-aos-delay="500">
              These projects were made using various APIs, CD/CI, libraries,
              frameworks and some backend as well.
            </p>
          ...
          <div className="pb-20 flex flex-col space-y-4">
            <h1 className="font-light text-2xl">More Projects</h1>
            <div className="space-y-10">
              ...
              <div>
                ...
                <h6 className="text-xs">
                  A forked branch that I worked on during my internship using
                  branches off main that were merged afterwards
                </h6>
            ...
            <div>
              <div className="space-y-10">
                <div data-aos="fade-in">
                  <h1 className="text-3xl">Awesome Chat</h1>
                  <p>NextJS, SASS, Mixin, Firebase v9 </p>
                  <Links
                    Wlink="https://chat-app-ten-rouge.vercel.app/"
                    Glink="https://github.com/Achraf333-m/Chat-app"
                  />
                  <div className="project-style">
                    <Image
                      alt="section-image"
                      className="hover-transition lg:!w-[500px]"
                      data-aos="fade-right"
                      src={chatApp}
                    />
                  </div>
